...
const SPOT_TEMPLATES = [
  ...
  { prefix: "International Village", base: [42.3407, -71.089] },
  ...
  { prefix: "Ryder Hall", base: [42.339, -71.0878] },
  { prefix: "Churchill Hall", base: [42.3378, -71.0908] },
  { prefix: "Egan Research Center", base: [42.34, -71.0898] },
  { prefix: "Richards Hall", base: [42.3372, -71.0885] },
  { prefix: "Mugar Life Sciences", base: [42.3395, -71.0905] },
  { prefix: "West Village F", base: [42.337, -71.0925] },
  { prefix: "West Village G", base: [42.3368, -71.092] },
  { prefix: "West Village H", base: [42.337, -71.0915] },
  { prefix: "Caffè Bene", base: [42.3427, -71.0855] },
  { prefix: "Wishing Cup", base: [42.3586, -71.059] },
  { prefix: "Jaho Coffee Back Bay", base: [42.348, -71.0776] },
  ...
  { prefix: "Caffè Nero South End", base: [42.3446, -71.071] },
  { prefix: "Boston Public Library", base: [42.3494, -71.0784] },
  { prefix: "Capital One Cafe", base: [42.349, -71.0765] },
  ...
  { prefix: "Trident Booksellers", base: [42.349, -71.0825] },
];
